...
<p>$x_a$ equilibrium flows in link $a$, $t_a$ travel time on link $a,\ f_k^{rs}$ flow on path $k$ connecting O-D pair r-s, $q_{rs}$ trip rate between $r$ and $s$ and $ &delta;$ is a binary function equal to 1 when link $a$ belongs to path of $k$, otherwise 0.</p>
...
<li>Y. Sheffi (1985), Urban Transportation Networks: Equilibrium Analysis with Mathematical Programming Methods. Prentice-Hall Inc., Englewood Cliffs, New Jersey.</li>
</ul>
<span class="title1">Website</span>
<li><a href="http://www.cdeep.iitb.ac.in/nptel/Civil%20Engineering/Transportation%20Engg%20I/72-homes/10-home.html">www.cdeep.iitb.ac.in/nptel/</a></li>
</div>
<?php
