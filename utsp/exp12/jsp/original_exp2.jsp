...
<title>Original Image and Histogram</title>
<style type="text/css">
html {height:100%;}
...
Original Image(<%=fname%>)</br>
<img id="pointer_div" src="output/<%=session_user%>/out_original_img.jpg?date=<%=dt%>">
</br>

<%if(nob>0)
 {%>
 Histogram for band <%=nob%></br>
 <img id="pointer_div" src="output/<%=session_user%>/out_hist_band<%=nob%>.jpg?date=<%=dt%>"  width="600" height="500">
</br>
 <%}
 else
 {
 	for(int i=1;i<=3;i++)
    {
    	...
    	<img id="pointer_div" src="output/<%=session_user%>/out_hist_band<%=i%>.jpg?date=<%=dt%>"  width="600" height="500">
 	<%}
 }%>
