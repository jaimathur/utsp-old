...
if(cookies!=null)
{
	...
	for(int i=0;i<cookies.length;i++)
	{
		...
		else if(cookies[i].getName().equals("rootuploadpath"))
		{
			...
			if(globalinpath.lastIndexOf("\"")>0)
				globalinpath=globalinpath.substring(1,globalinpath.length()-1);
				//out.println(outpath);
		...
		else if(cookies[i].getName().equals("exppath"))
		{
			...
			if(exppath.lastIndexOf("\"")>0)
				exppath=exppath.substring(1,exppath.length()-1);
			//out.println(exppath);
