...
getHeader(6,"System Optimal Assignment","Trip Assignment");
...
$stuff = mysql_query("SELECT * FROM selfeval where ExpNo='10' order by Srno") or die("MySQL Login Error: ".mysql_error()); 
