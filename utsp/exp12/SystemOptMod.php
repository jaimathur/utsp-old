...
{	
		...
		document.Frm.action="SystemOptModUserDisplay.php?Exp=10";
}
function chk2()
{	
	document.Frm.action="SystemOptDefault.php?Exp=10";
}
</script>
...
<center> 
<form enctype="multipart/form-data" method="post" name="Frm" action="SystemOptMod.php?Exp=10">
