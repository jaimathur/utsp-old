...
<title>Outputs of Parallelopiped Classification</title>
<style type="text/css">
html {height:100%;}
...
<div id="bg">
  <img src="../siplabs_old_matlab/images/img082.jpg" width="100%" height="100%" alt="">
...
<img id="pointer_div" src="output/<%=session_user%>/out_parallelopiped.bmp?date=<%=dt%>">
</br>
