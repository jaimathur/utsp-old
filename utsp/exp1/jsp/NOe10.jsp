...
init=request.getParameter("D2"); //name of image
	selected=init;
	method=request.getParameter("D1"); //name of transform
	...
	//--To copy output generated HSV file to user input space--//
	if(request.getParameter("D1").equals("RGB to HSV"))
	{
		InputStream fin = new FileInputStream("C:/Program Files/Apache Software Foundation/Tomcat 5.5/webapps/siplabs/output/"+session_user+"/out_HSV.tif");
    		OutputStream fout = new FileOutputStream("c:/uploads/common/HSV_out.tif");
