...
<title>Experiment 11: Maximum Likelihood Classification</title>
...
//alert("");
    ...
    form.setAttribute("action", "output_exp11.jsp");
...
//alert("c");
    ...
    window.open("output_exp11.html", 'formresult', 'scrollbars=yes,menubar=no,height=600,width=650,resizable=yes,toolbar=no,status=no');
