...
getHeader(6,"Doubly constrained Gravity Model","Trip Distribution");
...
$stuff = mysql_query("SELECT * FROM selfeval where ExpNo='4' order by Srno") or die("MySQL Login Error: ".mysql_error()); 
