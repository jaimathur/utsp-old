...
getHeader(6,"Singly constrained Gravity Model","Trip Distribution");
...
$stuff = mysql_query("SELECT * FROM selfeval where ExpNo='3' order by Srno") or die("MySQL Login Error: ".mysql_error()); 
...
{ 
  ...
  echo(' 
  <Input type = "hidden" Name = "Exp" Value = "3" />
