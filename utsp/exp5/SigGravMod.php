...
$file = fopen($folder."SigGravModReport.xls", "w");   
fclose($file);
...
{	
	...
	document.Frm.action="SigGravModUserDisplay.php?Exp=3";
}
function chk2()
{	
	document.Frm.action="SigGravModDefault.php?Exp=3";
}
</script>
...
<div id="scroller"><table class="table table-bordered table-hover">
<tr>
<td>
...
<tr>
<td align="right"><img src="img/SmallXLS.jpg" alt="Excel" /></td><td align="left"><strong><a href="<?php echo DOC_FOLDER;?>/costmatrix.xls">- (Click Here) For Base Year O-D Cost Matrix File (xls)</a></strong></td>
</tr>
<tr>
<td align="right"><img src="img/SmallXLS.jpg" alt="Excel" /></td><td align="left"><strong><a href="<?php echo DOC_FOLDER;?>/Origin_gravity.xls">- (Click Here) For Future Year Origin Total File (xls)</a></strong></td>
</tr>
<tr>
<td align="right"><img src="img/SmallXLS.jpg" alt="Excel" /></td><td align="left"><strong><a href="<?php echo DOC_FOLDER;?>/destination_gravity.xls">- (Click Here) For Future Year Destination Total File (xls)</a></strong></td>
</tr>
<tr>
<td align="right"><img src="img/SmallCSV.jpg" alt="CSV" /></td><td align="left"><strong><a href="<?php echo DOC_FOLDER;?>/costmatrixcsv.csv">- (Click Here) For Base Year O-D Cost Matrix File (csv)</a></strong></td>
</tr>
<tr>
<td align="right"><img src="img/SmallCSV.jpg" alt="CSV" /></td><td align="left"><strong><a href="<?php echo DOC_FOLDER;?>/Origin_gravitycsv.csv">- (Click Here) For Future Year Origin Total File (csv)</a></strong></td>
</tr>
<tr>
<td align="right"><img src="img/SmallCSV.jpg" alt="CSV" /></td><td align="left"><strong><a href="<?php echo DOC_FOLDER;?>/destination_gravitycsv.csv">- (Click Here) For Future Year Destination Total File (csv)</a></strong></td>
</tr>
</table>
<br>

<td align="left"><input type="submit" class=button value="Submit" name="Submit" OnClick="return chk1()">
<span class="tab"></span><input type="Reset" class=button value="Reset"></td>
