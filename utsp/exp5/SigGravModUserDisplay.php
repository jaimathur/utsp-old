...
<script language="javaScript" src="exp_col.js"></script>
...
function chk1()
{ 
	document.Frm.action="SigGravModDefaultInput.php?Exp=3";	
}
...
<form enctype="multipart/form-data" method="post" name="Frm" action="SigGravModUserDisplay.php?Exp=3">
...
<span class="tab"></span>
<input type="submit" class="button"  name= "btn4" value="Next" name="Submit" OnClick="return chk1()">
</div> 
<?php 
