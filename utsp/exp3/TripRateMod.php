...
{	
	...
	document.Frm.action="TripRateMod2.php?Exp=17";
}
function chk2()
{	
	document.Frm.action="TripRateModDefault.php?Exp=17";
}
</script>

</head>
<div id="body">
<h1 class="title_header1" align="right">Catagory Analysis</h1>
<center>   
<form enctype="multipart/form-data" method="post" name="Frm" action="TripRateMod.php?Exp=17">
