...
function chk1()
{
	...
	//alert(document.Frm.getElementById("CostFile"));
	
	document.Frm.action="CaliDoubModDefaultDisplay.php?Exp=6";
}
function chk2()
{	
	document.Frm.action="CaliDoubModDefault.php?Exp=6";
}
</script>
...
<center> <br><br>
<form enctype="multipart/form-data" method="post" name="Frm" action="CaliDoubMod.php?Exp=6">
