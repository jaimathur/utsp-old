...
?>
	...
	switch($id) {
      ...
      <div class="modal-body">
         <p style="margin:0px; padding: 0px;"><i>Please give us your valuable feedback for the improvement of the UTSP VLab.</i></p>            
      </div>
      <div class="modal-footer">
         <a href="../feedback.php" class="button">Continue</a>
         <a href="../login/logout.php" class="button">Exit</a>
      </div>
   </div>
  				...
  				<div class="row">
        			...
        			<div class="span4 pull-right">
      					<ul id="menu-bar1">
              				...
              				<li ><a  data-toggle="modal" href="#example">Logout</a></li>
          				</ul>
        			</div>
