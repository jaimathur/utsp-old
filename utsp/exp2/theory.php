...
<p>
 	<ul class="test">
 		<li>Quadratic</li>
 		<li>Power e.g. $(y\ =\ a_0x_0^{b_0}\ +\ a_1x_1^{b_1}+\ ....)$</li>
 		<li>Exponential e.g. $(y\ =\ a_0e_0^{x_0}\ +\ a_1e_1^{x_1}+\ ....)$</li>
 		<li>Logarithmic e.g.  $(y\ =\ a_0\ +\ a_1 ln(x_0)\ +\ a_2 ln(x_1)+\ ....)$</li>
	 </ul>
</p>
