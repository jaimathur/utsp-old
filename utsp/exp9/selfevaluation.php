...
$stuff = mysql_query("SELECT * FROM selfeval where ExpNo='7' order by Srno") or die("MySQL Login Error: ".mysql_error()); 
...
{ 
  ...
  echo(' 
  <Input type = "hidden" Name = "Exp" Value = "7" />
