...
<div align="left">
<b>Where,</b><br>
<b>t<sup>u</sup><sub>ij</sub></b> = In-Vehicle Travel time<br>
<b>t<sup>w</sup><sub>ij</sub></b> = Walking time<br>
<b>t<sup>t</sup><sub>ij</sub></b> = Waiting time<br>
<b>f<sub>ij</sub></b> = Fare Charged<br>
<b>P<sup>c</sup></b> = Parking Cost<br>
<b>&Phi;<sub>ij</sub></b> = Other parameters<br>
</p>
</div>
...
for ($i = 0; $i < $m_nmode;$i++) 
{
	...
	$m_pij[$i]= round($m_exp[$i]/$m_sumexp,4);
...
for ($i = 0; $i < $m_nmode;$i++) 
{
	...
	echo '<td bgcolor="#EBF5FF" width="5%">'.round($m_exp[$i],4).'</td>';
...
<b>P<sup>c</sup></b> = Parking Cost<br>
<b>&Phi;<sub>ij</sub></b> = Other parameters<br>
<b>C</b> = Cost of travel by particular mode<br>
<b>p<sub>ij</sub></b> = Probability of choosing mode<br>
<b>T<sub>ij</sub></b> = Proportion of trips<br>
</p>
</div>
<br><br>
