...
?> 
    ...
    <p class="section">Modal share, Mode split or Mode choice analysis is the third step in the conventional four-step transportation forecasting model, following trip generation and trip distribution but before route assignment. In Trip distribution step, zonal interchange analysis yields a set of origin destination tables which tells where the trips will be made. Mode choice analysis allows the modeller to determine what mode of transport will be used, and what modal share results.</p>
    <span class="title">Types of Mode Split Models</span>

<ul class="xxxx">
<p><span class="xxxxx">Trip-end modal split models</span>
Traditionally, the objective of transportation planning is to forecast the growth in demand for car trips in order to plan the investment 
to meet the demand. When personal characteristics were thought to be the most important determinants
 ...
 In this way different characteristics of the person could be preserved and used to estimate modal split. The modal split models of this time related is the 
choice of mode related to features like income, residential density and car ownership. The advantage is that these models could be very accurate in the short run,
 if public transport is available and there is little congestion. Limitation is that they are insensitive to policy decisions, for example: Improving public transport, 
restricting parking etc. would have no effect on modal split according to these trip-end models.
</p>
<p><span class="xxxxx">Trip-interchange modal split models</span>
...
<span class="title1">Website</span>
<ul class="test" >
<li><a href="http://www.cdeep.iitb.ac.in/nptel/Civil%20Engineering/Transportation%20Engg%20I/72-homes/09-home.html">www.cdeep.iitb.ac.in/nptel/</a></li>
</ul>
