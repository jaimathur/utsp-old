...
include_once("../sessioncheck.php");
  ...
  getHeader(5,"All or Nothing (AON) Assignment","Trip Assignment");
?> 
	<div id="body">
<h1 class="title_header1" align="right">All or Nothing Assignment</h1>
    ...
    <ul class="questions">
      <li>What is link?<span class="answers">An element of a transportation network that connects two nodes.
       ...
       <li>What are Routes in network?<br/><span class="answers">Pathways through a network. 
        Routes are composed of links and nodes.</span></li>
       
       <li>What is Trip Assignment Analysis?
        <span class="answers">The process used to estimate the 
        routes (for each mode) that will be used 
        to travel from origin to destination. This process yields the total number 
        of vehicles or passengers that 
        a particular route can expect to service.</span></li>

       <li>Why this assignment is called All-or-nothing assignment ?
        <span class="answers">
       ...
       Though All-or-nothing is unrealistic as only one path between every O-D pair is utilised, 
       this model may be reasonable in sparse and uncongested networks where there arefew alternative routes and they have a large difference in travel cost.
                   This model may also be used to identify the path which the drivers would like 
                   to travel in the absence of congestion.</span></li>
    </ul>
  </div>
<?php
