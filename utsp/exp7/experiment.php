...
<ul class="objective">
<li>
Origin Destination trip data for base year. 
</li>
<li>
Origin Destination trip cost for base year.
</li>
</ul>
...
<p><span class="title1"><a href="javascript:void(0);" onClick="fullScreen('applet/CaliGrav.php')"; style="text-decoration: underline;">Click Here to Perform Experiment with JAVA based Simulation</a></span></p>
<p><span class="title1"><a href="CaliSingMod.php" style="text-decoration: underline;">Click Here to Perform Experiment with PHP based Simulation</a></span></p>
<br>
