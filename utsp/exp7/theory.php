...
<ul class="test1">
<li>Assume a trial value of &beta;.</li>
...
<li>This error is minimised for an optimised value of &beta;.</li>
<li>At the end of the calibration we get an optimised value of &beta;.</li>
</ul>
