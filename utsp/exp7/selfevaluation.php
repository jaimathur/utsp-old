...
getHeader(6,"Calibration of Singly Constrained Gravity Model","Trip Distribution");
...
$stuff = mysql_query("SELECT * FROM selfeval where ExpNo='5' order by Srno") or die("MySQL Login Error: ".mysql_error()); 
